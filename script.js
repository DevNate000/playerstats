...
fetch(`https://scraper.nt-verse.com/api/racer/toughboy05`).then((data)=>{
        return data.json();
}).then((objectData)=>{
    let tableData=`<tr>
    <td>🏎</td>    
    ...
    document.getElementById("2guest_table").innerHTML=tableData;
})  .catch((err)=>{
    console.log(err);
})
// ----------------------------------------------------------------------------------------- //
...
fetch(`https://scraper.nt-verse.com/api/racer/billy33`).then((data)=>{
    ...
    document.getElementById("3guest_table").innerHTML=tableData;
})  .catch((err)=>{
    console.log(err);
})
// ----------------------------------------------------------------------------------------- //
